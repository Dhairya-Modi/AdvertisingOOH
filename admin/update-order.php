...
<div class="main-content">
    ...
    ?>
        ...
        ?>
        <?php
                $_SESSION['currentStatus']="<div class='text-center' style='font-size: 20px; color:green;'>Your order of $hoarding and order-id $id is $status</div>";
                // header("location:");
            ?>
    </div>
</div>
